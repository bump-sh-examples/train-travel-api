...
class StationsService {
    ...
    toRouter() {
        this.router.get("/stations", (req, res, next) => __awaiter(this, void 0, void 0, function* () {
            try {
                yield this.methods.getStations(req, {
                    send: (responseBody) => __awaiter(this, void 0, void 0, function* () {
                        res.json(serializers.GetStationsResponse.jsonOrThrow(responseBody, {
                ...
                if (error instanceof errors.BumpshApiError) {
                    switch (error.errorName) {
                        ...
                        case "InternalServerError":
                            break;
                        default:
                            console.warn(`Endpoint 'get-stations' unexpectedly threw ${error.constructor.name}.` +
